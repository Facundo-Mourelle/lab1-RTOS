...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define LED1 GPIO_PIN_13 // naranja
#define LED2 GPIO_PIN_15 // azul
...
void MX_GPIO_Init(void) {
  ...
  /* Botón como entrada — PA0 tiene pull-down externo en la Discovery */
  gpio.Pin = BUTTON_PIN;
...
int main(void) {
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
  xTaskCreate(vTareaLED, "LED1", 128, NULL, 1, NULL);
  xTaskCreate(vTareaBoton, "BTN", 128, NULL, 2, NULL);
  /* USER CODE END 2 */
